...
extern int bootram_console_stdio_write(char *buf, size_t size);
#define bootram_console_printf(format, ...)     __wrap_sprintf((stdio_write_fn)bootram_console_stdio_write, format, ##__VA_ARGS__)
