...
static void uart_io_pin_request(struct Serial *serial)
{
...
#elif defined (LN882x)
        HAL_SYSCON_FuncIOSet(GPIO_AF_UART0_RX, GPIO_AF_IO_18, en); //LN882x: GPIO_B[8], FULL_MUX_18, PAD24 [rom_uart0 RX]
        HAL_SYSCON_FuncIOSet(GPIO_AF_UART0_TX, GPIO_AF_IO_19, en); //LN882x: GPIO_B[9], FULL_MUX_19, PAD25 [rom_uart0 TX]
#else
  #error Add your bord type!!!
        ...
        HAL_SYSCON_FuncIOSet(GPIO_AF_UART1_RX, GPIO_AF_IO_18, en);//LN8820 (LN8825) &BLE EVB: GPIOB6, FULL_MUX_16, Pin31
        HAL_SYSCON_FuncIOSet(GPIO_AF_UART1_TX, GPIO_AF_IO_19, en);//LN8820 (LN8825) &BLE EVB: GPIOB7, FULL_MUX_17, Pin32
    #endif
#else
  #error Add your bord type!!!
#endif
...
#elif defined (LN882x)
        //TODO:待最终demo板确认
        HAL_SYSCON_FuncIOSet(GPIO_AF_UART1_RX, GPIO_AF_IO_18, en);//LN882x: GPIO_1[5], FULL_MUX_15, PAD21
        HAL_SYSCON_FuncIOSet(GPIO_AF_UART1_TX, GPIO_AF_IO_19, en);//LN882x: GPIO_1[6], FULL_MUX_16, PAD22
#else
  #error Add your bord type!!!
#endif
    }
...
static const struct SerialHardwareVT uart0_vtable =
{
    ...
    .txStart     = hw_uart_txStartPolling,
